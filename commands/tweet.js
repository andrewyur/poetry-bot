...
export async function execute(interaction) {
	...
	try {
		const tweet = await completion('you are a gen z internet microcelebrity, famous for his weird, freaky, gross, and unhinged gen z style tweets using modern internet slang.');
