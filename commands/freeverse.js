...
export const data = new SlashCommandBuilder()
	.setName("freeverse")
	.setDescription(
		"have the bot write a free verse poem on the subject of your choice"
	)
...
export async function execute(interaction) {
	...
	try {
		const freeverse = await completion(
			"write a super short free verse poem on the given subject",
			subject
		);
		interaction.editReply(freeverse);
	} catch (error) {
